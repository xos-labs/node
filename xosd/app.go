...
import (
	...
	evmante "github.com/xos-labs/node/ante"
	cosmosevmante "github.com/xos-labs/node/ante/evm"
	evmosencoding "github.com/xos-labs/node/encoding"
	srvflags "github.com/xos-labs/node/server/flags"
	cosmosevmtypes "github.com/xos-labs/node/types"
	cosmosevmutils "github.com/xos-labs/node/utils"
	"github.com/xos-labs/node/x/erc20"
	erc20keeper "github.com/xos-labs/node/x/erc20/keeper"
	erc20types "github.com/xos-labs/node/x/erc20/types"
	erc20v2 "github.com/xos-labs/node/x/erc20/v2"
	"github.com/xos-labs/node/x/feemarket"
	feemarketkeeper "github.com/xos-labs/node/x/feemarket/keeper"
	feemarkettypes "github.com/xos-labs/node/x/feemarket/types"
	"github.com/xos-labs/node/x/ibc/transfer"
	transferkeeper "github.com/xos-labs/node/x/ibc/transfer/keeper"
	transferv2 "github.com/xos-labs/node/x/ibc/transfer/v2"
	"github.com/xos-labs/node/x/vm"
	evmkeeper "github.com/xos-labs/node/x/vm/keeper"
	evmtypes "github.com/xos-labs/node/x/vm/types"
	chainante "github.com/xos-labs/node/xosd/ante"
...
func init() {
	...
	var err error
	DefaultNodeHome, err = clienthelpers.GetNodeHomeDirectory(".xosd")
	if err != nil {
		panic(err)
	}
}
...
var (
	_ runtime.AppI            = (*XOSD)(nil)
	_ servertypes.Application = (*XOSD)(nil)
	_ ibctesting.TestingApp   = (*XOSD)(nil)
)
...
func (app *XOSD) setAnteHandler(txConfig client.TxConfig, maxGasWanted uint64) {
...
func (app *XOSD) Name() string { return app.BaseApp.Name() }
...
// TxConfig returns XOSD's TxConfig
