...
//
// Why was this copied?
// This test suite was copied to verify that AppChain (EVM-based chain)
// correctly implements IBC v2 packet handling logic, including send, receive,
// acknowledgement, and timeout flows.
// Additionally, we made slight modifications to confirm AppChain's behavior
...
import (
	...
	evmibctesting "github.com/xos-labs/node/ibc/testing"
...
// TestOnSendPacket tests AppChain's implementation of the OnSendPacket callback.
func (suite *TransferTestSuiteV2) TestOnSendPacket() {
	...
	for _, tc := range testCases {
		suite.Run(tc.name, func() {
			...
			evmApp := suite.evmChainA.App.(*xosd.XOSD)
...
// TestOnRecvPacket tests AppChain's implementation of the OnRecvPacket callback.
...
// TestOnAckPacket tests AppChain's implementation of the OnAckPacket callback.
...
// TestOnTimeoutPacket tests AppChain's implementation of the OnTimeoutPacket callback.
