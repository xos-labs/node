...
// Why was this copied?
// This test suite was imported to validate that AppChain (an EVM-based chain)
...
import (
	...
	"github.com/xos-labs/node/precompiles/ics20"
...
func (suite *ICS20TransferTestSuite) SetupTest() {
	...
	evmAppA := suite.chainA.App.(*xosd.XOSD)
	...
	evmAppB := suite.chainB.App.(*xosd.XOSD)
