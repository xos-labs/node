...
import (
	...
	testfactory "github.com/xos-labs/node/testutil/integration/os/factory"
	testhandler "github.com/xos-labs/node/testutil/integration/os/grpc"
	testkeyring "github.com/xos-labs/node/testutil/integration/os/keyring"
	testnetwork "github.com/xos-labs/node/testutil/integration/os/network"
	"github.com/xos-labs/node/x/vm"
	"github.com/xos-labs/node/x/vm/statedb"
	"github.com/xos-labs/node/x/vm/types"
...
func TestExportGenesis(t *testing.T) {
	...
	require.Contains(t, genAddresses, testconstants.WTOKENContractMainnet, "expected mainnet aatom contract address in exported genesis")
}
