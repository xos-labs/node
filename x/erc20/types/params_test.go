...
func (suite *ParamsTestSuite) TestParamsValidate() {
	testCases := []struct {
		...
		},
		{
			...
			func() types.Params {
				return types.NewParams(true, []string{}, []string{testconstants.WTOKENContractMainnet})
			},
			false,
			"",
		},
		{
			...
			func() types.Params {
				return types.NewParams(true, []string{testconstants.WTOKENContractMainnet}, []string{})
			},
			false,
			"",
		},
		{
			...
			func() types.Params {
				return types.NewParams(true, []string{testconstants.WTOKENContractTestnet, testconstants.WTOKENContractMainnet}, []string{})
			},
			false,
			"",
		},
		{
			...
			// order of creation shouldn't matter since it should be sorted when defining new param
			func() types.Params {
				return types.NewParams(true, []string{testconstants.WTOKENContractMainnet, testconstants.WTOKENContractTestnet}, []string{})
			},
			false,
			"",
		},
		...
		},
		{
			...
			func() types.Params {
				return types.NewParams(true, []string{testconstants.WTOKENContractMainnet}, []string{testconstants.WTOKENContractMainnet})
			},
			true,
		...
		},
		{
			...
			func() types.Params {
				return types.NewParams(true, []string{testconstants.WTOKENContractMainnet, testconstants.WTOKENContractMainnet}, []string{})
			},
			true,
			"duplicate precompile",
		},
		{
			...
			func() types.Params {
				return types.NewParams(true, []string{}, []string{testconstants.WTOKENContractMainnet, testconstants.WTOKENContractMainnet})
			},
			true,
			"duplicate precompile",
		},
		...
		},
		{
			...
			func() types.Params {
				...
				params.NativePrecompiles = []string{testconstants.WTOKENContractTestnet, testconstants.WTOKENContractMainnet}
				return params
			},
			true,
...
func (suite *ParamsTestSuite) TestIsNativePrecompile() {
	testCases := []struct {
	...
	}{
		{
			...
			common.HexToAddress(testconstants.WTOKENContractMainnet),
			true,
		},
		{
		...
		},
		{
			...
			common.HexToAddress(testconstants.WTOKENContractTestnet),
			true,
		},
		{
