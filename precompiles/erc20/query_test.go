...
import (
	...
	app "github.com/xos-labs/node/xosd"
...
func (s *PrecompileTestSuite) TestNameSymbol() {
	...
	testcases := []struct {
		name        string
		denom       string
		malleate    func(sdk.Context, *app.XOSD)
		expPass     bool
		errContains string
		expName     string
		expSymbol   string
		...
		},
		{
			...
			malleate: func(ctx sdk.Context, app *app.XOSD) {
...
func (s *PrecompileTestSuite) TestTotalSupply() {
	...
	testcases := []struct {
		name        string
		malleate    func(sdk.Context, *app.XOSD, *big.Int)
		expPass     bool
		errContains string
		expTotal    *big.Int
	}{
		...
		},
		{
			...
			malleate: func(ctx sdk.Context, app *app.XOSD, amount *big.Int) {
				// NOTE: we mint some coins to the inflation module address to be able to set denom metadata
...
func (s *PrecompileTestSuite) TestBalanceOf() {
	...
	testcases := []struct {
		name        string
		malleate    func(sdk.Context, *app.XOSD, *big.Int) []interface{}
		expPass     bool
		errContains string
		expBalance  *big.Int
	}{
		{
			...
			malleate: func(_ sdk.Context, _ *app.XOSD, _ *big.Int) []interface{} {
				return []interface{}{}
			},
		...
		{
			name: "pass - some coins",
			malleate: func(ctx sdk.Context, app *app.XOSD, amount *big.Int) []interface{} {
...
func (s *PrecompileTestSuite) TestAllowance() {
	...
	testcases := []struct {
		...
		},
		{
			...
			malleate: func(_ sdk.Context, _ *app.XOSD, amount *big.Int) []interface{} {
				granterIdx := 0
				granteeIdx := 1
